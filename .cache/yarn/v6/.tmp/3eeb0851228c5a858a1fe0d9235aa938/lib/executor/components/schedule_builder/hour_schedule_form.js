...
exports.HourScheduleBuilder = void 0;
...
class HourScheduleBuilder extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (React.createElement(core_1.Grid, { container: true, spacing: 1, className: styles_1.CSS.gridSpacing },
            ...
            React.createElement(core_1.Grid, { item: true, xs: 2, className: styles_1.CSS.gridTopRowSpacing },
                React.createElement(text_input_1.TextInput, { name: "frequency", type: "number", min: "1", max: "23", value: this.state.frequency, hasError: !this.state.frequency, onChange: e => this.setState({ frequency: e.target.value }) })),
            ...
            React.createElement(core_1.Grid, { item: true, xs: 12, className: styles_1.CSS.gridSpacing },
                React.createElement(validation_error_1.CheckValidation, { min: 1, max: 24, fieldName: 'Frequency', required: true, value: this.state.frequency }),
                ' '),
            ...
            React.createElement(core_1.Grid, { item: true, xs: 2, className: styles_1.CSS.gridSpacing },
                React.createElement(text_input_1.TextInput, { name: "specifiedMinute", type: "number", min: "0", max: "59", value: this.state.specifiedMinute, hasError: !this.state.specifiedMinute, onChange: e => this.setState({ specifiedMinute: e.target.value }) })),
            React.createElement(core_1.Grid, { item: true, xs: 7, className: styles_1.CSS.gridSpacing },
                React.createElement("p", { className: styles_1.CSS.scheduleLabel }, "minute of hour")),
            React.createElement(core_1.Grid, { item: true, xs: 12, className: styles_1.CSS.gridSpacing },
                React.createElement(validation_error_1.CheckValidation, { min: 0, max: 59, fieldName: 'Repeat (minute)', required: true, value: this.state.specifiedMinute }))));
    }
}
exports.HourScheduleBuilder = HourScheduleBuilder;
